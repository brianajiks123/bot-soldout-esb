...
async function sendMessage(text, replyMarkup = null, retries = 3) {
  ...
  const payload = { chat_id: CHAT_ID, text: cleanMessage(text), parse_mode: 'Markdown' };
...
module.exports = { sendMessage, answerCallbackQuery, getUpdates, validateToken, isConfigured };
